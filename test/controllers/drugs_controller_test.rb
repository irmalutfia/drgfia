...
class DrugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post drugs_url, params: { drug: { name: @drug.name, price_per_unit: @drug.price_per_unit, qty: @drug.qty, unit: @drug.unit } }
    end
  ...
  test "should update drug" do
    patch drug_url(@drug), params: { drug: { name: @drug.name, price_per_unit: @drug.price_per_unit, qty: @drug.qty, unit: @drug.unit } }
